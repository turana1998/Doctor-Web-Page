...
<head>
    ...
    <title>Turana Ismayilova | Admin Panel</title>
    <!-- This page CSS -->
    <!-- chartist CSS -->
    ...
    <?php if($General->PageNameGet() == "xidmetler-elave" || 
	$General->PageNameGet() == "xidmetler-siyahi" || 
	$General->PageNameGet() == "xidmetler-redakte") { ?>
    <link rel="stylesheet" href="../../css/et-line-icons.css" />
    <link rel="stylesheet" href="dist/css/pages/icon-services.css" />
    <?php } ?>
...
<body class="skin-default-dark fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Turana Ismayilova</p>
        </div>
    </div>
    <!-- ============================================================== -->
